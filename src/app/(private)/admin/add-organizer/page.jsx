...
const EyeIcon = (props) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    ...
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M2.458 12C3.732 7.943 7.523 5 12 5c4.477 0 8.268 2.943 9.542 7-1.274 4.057-5.065 7-9.542 7-4.477 0-8.268-2.943-9.542-7z"></path>
  </svg>
);

const EyeOffIcon = (props) => (
  <svg {...props} fill="none" stroke="currentColor" viewBox="0 0 24 24" xmlns="http://www.w3.org/2000/svg">
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M13.875 18.828c-1.554 1.156-3.35 1.776-5.275 1.776H4.5A2.25 2.25 0 012.25 18V6A2.25 2.25 0 014.5 3.75h4.125c1.925 0 3.721.62 5.275 1.776m-5.275 1.156A3.75 3.75 0 1018.75 12.375M12 18V6m-1.5 6L12 9l1.5 3"></path>
    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth="1" d="M21 21L3 3"></path>
  </svg>
);
            ...
            <div className="min-h-screen flex flex-col px-6 py-6 md:px-24 md:py-8">
                ...
                <form onSubmit={testSubmit} className="flex flex-col gap-5 mt-6">
                    <div className="flex flex-col gap-1 w-full">
                        ...
                        <input type="text" name="username" onChange={(e) => setUsername(e.target.value)} className="focus:outline-none focus:ring-2 ring-1 focus:ring-[#7209b7]/80 rounded-md py-2 px-3"/>
                    </div>
                    <PasswordToggleInput value={password} onChange={(e) => setPassword(e.target.value)} />
                    <div className="flex flex-col gap-1 w-full">
                        <label htmlFor="name">Name</label>
                        <input type="text" name="name" onChange={(e) => setName(e.target.value)} className="focus:outline-none focus:ring-2 ring-1 focus:ring-[#7209b7]/80 rounded-md py-2 px-3"/>
                    </div>
                    <div className="flex flex-col gap-1 w-full">
                        <label htmlFor="eventId">Event</label>
                        <select disabled={true} name="eventId" onChange={(e) => setEventId(e.target.value)} className="focus:outline-none focus:ring-2 ring-1 focus:ring-[#7209b7]/80 rounded-md py-2 px-3">
