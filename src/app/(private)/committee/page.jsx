...
export default function Page() {
    ...
    const API_URL = "https://capsular-peddlingly-immanuel.ngrok-free.dev/webhook/post/attend";
    ...
    return (
        <div className="min-h-screen bg-gray-50 flex flex-col items-center p-4 sm:p-8">
            <button disabled={loadingSignOut} onClick={handleSignOut} className="flex flex-row gap-2 text-white font-medium py-2 px-4 rounded-md bg-red-500 self-start my-6 hover:bg-red-400 active:opacity-80 transition duration-100 disabled:bg-gray-500">{loadingSignOut ? 'Tunggu...' : 'Log Out'}</button>
