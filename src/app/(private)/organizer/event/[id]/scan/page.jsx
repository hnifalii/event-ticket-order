    ...
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-4 sm:p-8">
      <div className="flex flex-row gap-2 self-start">
        <Link
          ...
          className="flex flex-row gap-2 text-white font-medium py-2 px-4 rounded-md bg-[#7209b7] self-start my-6 hover:bg-[#7209b7]/80 active:opacity-80 transition duration-100 disabled:bg-gray-500"
        >
          Profile
        </Link>
        <button
