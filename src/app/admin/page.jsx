...
export default function QRScannerPage() {
  ...
  const API_URL =
    "https://unwinning-kieran-stutteringly.ngrok-free.dev/webhook-test/attendance";
    ...
    try {
      ...
      if (result && result.success === true) {
        setModal({
          ...
          message:
            result.data ||
            `Peserta berhasil diverifikasi! Berhasil attend pada: ${result.attended_at}`,
          type: "success",
        });
        setScanResult(text);
      } else {
        throw new Error(
          result.data || result.reason || "Verifikasi tiket gagal."
        );
      }
    } catch (err) {
  ...
  return (
    <div className="min-h-screen bg-gray-50 flex flex-col items-center p-4 sm:p-8">
      <h1
        className="font-extrabold text-4xl mb-10 text-gray-800"
