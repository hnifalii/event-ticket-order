    ...
    <main className="mx-auto py-10 px-24">
      ...
      <div className="gap-2">
        ...
        <div className="flex gap-2">
          <p className="font-medium block mb-1">Event Name:</p>
          <p>{ticket.name}</p>
        </div>

        {/* Price */}
        <div className="flex gap-2">
          <p className="font-medium block mb-1">Price:</p>
          <p>
            {ticket.price === 0
              ? "Gratis"
              : `Rp${ticket.price[type].toLocaleString()}`}
          </p>
        </div>
      </div>
      ...
      >
        ...
        <input
          name="price"
          type="number"
          value={ticket.price === 0 ? 0 : ticket.price[type]}
          hidden
          readOnly
        />
